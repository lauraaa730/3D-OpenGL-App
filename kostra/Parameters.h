...
glm::vec3 fireflyAmbient = glm::vec3(0.6f, 0.6f, 0.6f);               ///< \brief Ambient color component of the firefly light.
...
float fireflyLinear = 0.5f;                                           ///< \brief Linear attenuation factor for the firefly light.
float fireflyQuadratic = 0.1f;                                        ///< \brief Quadratic attenuation factor for the firefly light.
